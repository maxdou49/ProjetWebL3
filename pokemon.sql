...
--
-- Hôte : localhost
-- Généré le : mer. 22 mars 2023 à 17:21
...
--
-- Structure de la table `typechart`
--
...
--
-- Déchargement des données de la table `typechart`
--

INSERT INTO `typechart` (`def`, `atk`, `mult`) VALUES
(1, 1, 10),
(1, 2, 20),
(1, 3, 10),
(1, 4, 10),
...
--
-- Index pour la table `typechart`
--
ALTER TABLE `typechart`
  ADD PRIMARY KEY (`def`,`atk`);
